...
from model_twostream import TwoStreamStabilityPredictor
...
def main(args):
    ...
    # 创建模型
    model = TwoStreamStabilityPredictor(
        pretrained=True, backbone=args.backbone
    ).to(device)
    print(f"Model: TwoStreamStabilityPredictor with {args.backbone} backbone")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Two-Stream stability predictor")
    parser.add_argument("--data_dir", type=str, default="../dataset", help="Dataset dir")
    parser.add_argument("--output_dir", type=str, default="checkpoints_twostream", help="Output dir")
    parser.add_argument("--epochs", type=int, default=50, help="Number of epochs")
    parser.add_argument("--batch_size", type=int, default=32, help="Batch size")
    parser.add_argument("--lr", type=float, default=1e-4, help="Learning rate")
    parser.add_argument("--image_size", type=int, default=224, help="Image size")
    parser.add_argument("--padding_ratio", type=float, default=0.5, help="Padding ratio for local crop")
