...
# ============================================================
# 用法：
#   bash run_train_rgbd_seg_from_encoded_tiny_h100.sh        # 后台运行
#   bash run_train_rgbd_seg_from_encoded_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet RGBD Seg-From-Encoded Tiny - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="transunet_rgbd_seg_from_encoded_tiny_h100"
