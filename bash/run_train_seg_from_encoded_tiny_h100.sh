#!/bin/bash
# ============================================================
# TransUNet Seg-From-Encoded Tiny (RGB) 训练脚本 (H100)
# 分割头直接从 Transformer Encoded 特征解码，无 CNN skip connections
# ============================================================
# 用法：
#   bash run_train_seg_from_encoded_tiny_h100.sh        # 后台运行
#   bash run_train_seg_from_encoded_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet Seg-From-Encoded Tiny (RGB) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="tiny"
BATCH_SIZE=50              # tiny 模型最小，可以增大 batch
EPOCHS=150
LR=1e-4
NUM_WORKERS=16
SAVE_DIR="/DATA/disk0/hs_25/pa/checkpoints"
EXP_NAME="transunet_seg_from_encoded_tiny_h100"
