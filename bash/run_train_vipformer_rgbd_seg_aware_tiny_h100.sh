#!/bin/bash
# ============================================================
# VIPFormer RGBD Seg-Aware Tiny (双流) 训练脚本 (H100)
# Tiny 模型: 2+2 层 Transformer, 384 hidden dim
# RGBD: 5通道输入 (RGB + Depth + Target Mask)
# ============================================================
# 用法：
#   bash run_train_vipformer_rgbd_seg_aware_tiny_h100.sh        # 后台运行
#   bash run_train_vipformer_rgbd_seg_aware_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "VIPFormer RGBD Seg-Aware Tiny (双流) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="vipformer_rgbd_seg_aware_tiny_h100"
...
# ========== 运行训练 ==========
echo "实验名: ${EXP_NAME}"
echo "模型: VIPFormer-RGBD-SegAware-${MODEL_VARIANT}"
echo "架构: 2+2层 Transformer, 384 hidden dim, 双流融合"
echo "输入: RGBD 5通道 (RGB + Depth + Target Mask)"
...
TRAIN_CMD="python train/train_vipformer_rgbd_seg_aware.py \
    --config default \
    --model ${MODEL_VARIANT} \
    --exp_name ${EXP_NAME} \
