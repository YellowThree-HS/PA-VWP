#!/bin/bash
# ============================================================
# TransUNet Fusion Tiny (RGB) 训练脚本 (H100)
# ============================================================
# 用法：
#   bash run_train_fusion_tiny_h100.sh        # 后台运行
#   bash run_train_fusion_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet Fusion Tiny (RGB) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="transunet_fusion_tiny_h100"
