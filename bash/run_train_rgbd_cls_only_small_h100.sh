#!/bin/bash
# ============================================================
# TransUNet RGBD Cls-Only Small 训练脚本 (H100)
# ============================================================
# 用法：
#   bash run_train_rgbd_cls_only_small_h100.sh        # 后台运行
#   bash run_train_rgbd_cls_only_small_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet RGBD Cls-Only Small - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="small"
BATCH_SIZE=50              # RGBD 5通道 + cls_only
EPOCHS=150
LR=1e-4
NUM_WORKERS=16
# 注意：train_rgbd_cls_only.py 内部默认保存到 /DATA/disk0/hs_25/pa/checkpoints
EXP_NAME="transunet_rgbd_cls_only_small_h100"
