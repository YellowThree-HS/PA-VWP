#!/bin/bash
# ============================================================
# VIPFormer Seg-Aware Tiny (RGB) 训练脚本 (H100)
# Tiny 模型: 2+2 层 Transformer, 384 hidden dim
# RGB: 4通道输入 (RGB + Target Mask)
# ============================================================
# 用法：
#   bash run_train_vipformer_seg_aware_tiny_h100.sh        # 后台运行
#   bash run_train_vipformer_seg_aware_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "VIPFormer Seg-Aware Tiny (RGB) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="vipformer_seg_aware_tiny_h100"
...
# ========== 运行训练 ==========
echo "实验名: ${EXP_NAME}"
echo "模型: VIPFormer-SegAware-${MODEL_VARIANT}"
echo "架构: 2+2层 Transformer, 384 hidden dim"
...
TRAIN_CMD="python train/train_vipformer_seg_aware.py \
    --config default \
    --model ${MODEL_VARIANT} \
    --exp_name ${EXP_NAME} \
