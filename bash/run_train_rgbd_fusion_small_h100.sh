#!/bin/bash
# ============================================================
# TransUNet RGBD Fusion Small 训练脚本 (H100)
# ============================================================
# 用法：
#   bash run_train_rgbd_fusion_small_h100.sh        # 后台运行
#   bash run_train_rgbd_fusion_small_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet RGBD Fusion Small - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="small"
BATCH_SIZE=40              # RGBD 5通道 + small 模型
EPOCHS=150
LR=1e-4
NUM_WORKERS=16
SAVE_DIR="/DATA/disk0/hs_25/pa/checkpoints"
EXP_NAME="transunet_rgbd_fusion_small_h100"
