#!/bin/bash
# ============================================================
# TransUNet 双流网络 Seg-From-Encoded Tiny 训练脚本 (H100)
...
# ============================================================
# 用法：
#   bash run_train_twostream_seg_from_encoded_tiny_h100.sh        # 后台运行
#   bash run_train_twostream_seg_from_encoded_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet 双流网络 Seg-From-Encoded Tiny - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="transunet_twostream_seg_from_encoded_tiny_h100"
...
TRAIN_CMD="python train/train_twostream_seg_from_encoded.py \
    --config small \
    --model ${MODEL_VARIANT} \
    --exp_name ${EXP_NAME} \
