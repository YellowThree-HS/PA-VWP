#!/bin/bash
# ============================================================
# TransUNet RGBD Fusion Micro 训练脚本 (H100)
# Micro 模型: 2 层 Transformer, 192 hidden dim (超轻量级)
# RGBD: RGB + Depth 融合 (5通道输入)
# ============================================================
# 用法：
#   bash run_train_rgbd_fusion_micro_h100.sh        # 后台运行
#   bash run_train_rgbd_fusion_micro_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet RGBD Fusion Micro - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
EXP_NAME="transunet_rgbd_fusion_micro_h100"
