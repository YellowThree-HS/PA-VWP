#!/bin/bash
# ============================================================
# TransUNet Cls-Only Small (RGB) 训练脚本 (H100)
# ============================================================
# 用法：
#   bash run_train_cls_only_small_h100.sh        # 后台运行
#   bash run_train_cls_only_small_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet Cls-Only Small (RGB) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="small"
BATCH_SIZE=50              # cls_only 无分割头，显存更省
EPOCHS=150
LR=1e-4
NUM_WORKERS=16
# 注意：train_cls_only.py 内部默认保存到 /DATA/disk0/hs_25/pa/checkpoints
EXP_NAME="transunet_cls_only_small_h100"
