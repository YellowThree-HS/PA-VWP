#!/bin/bash
# ============================================================
# TransUNet Fusion Small (RGB) 训练脚本 (H100)
# ============================================================
# 用法：
#   bash run_train_fusion_small_h100.sh        # 后台运行
#   bash run_train_fusion_small_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet Fusion Small (RGB) - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="small"
BATCH_SIZE=50              # small 模型参数少，可以增大 batch
EPOCHS=150
LR=1e-4                    # small 模型适合稍大学习率
NUM_WORKERS=16
SAVE_DIR="/DATA/disk0/hs_25/pa/checkpoints"
EXP_NAME="transunet_fusion_small_h100"
