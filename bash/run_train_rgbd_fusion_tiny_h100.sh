#!/bin/bash
# ============================================================
# TransUNet RGBD Fusion Tiny 训练脚本 (H100)
# Tiny 模型: 4 层 Transformer, 256 hidden dim (轻量级)
# RGBD: RGB + Depth 融合 (5通道输入)
# ============================================================
# 用法：
#   bash run_train_rgbd_fusion_tiny_h100.sh        # 后台运行
#   bash run_train_rgbd_fusion_tiny_h100.sh -f     # 前台运行
...
echo "=============================================="
echo "TransUNet RGBD Fusion Tiny - H100"
echo "=============================================="
echo "开始时间: $(date)"
...
# ========== 超参数 ==========
MODEL_VARIANT="tiny"
BATCH_SIZE=45              # tiny 模型比 micro 稍大
EPOCHS=150
LR=1e-4
NUM_WORKERS=16
SAVE_DIR="/DATA/disk0/hs_25/pa/checkpoints"
EXP_NAME="transunet_rgbd_fusion_tiny_h100"
